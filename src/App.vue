        ...
        <div class="p-10">
            <div class="flex justify-between items-center">
                ...
                <div class="flex gap-4">
                    <select class="py-2 px-3 border rounded-xl outline-none">
                    ...
                    <div class="relative">
                        ...
                        <div>
                            <input class="transition border rounded-xl pl-10 py-1.5 pr-4 outline-none focus:border-gray-400" type="text" placeholder="Поиск...">
                        </div>
                    </div>
                </div>
            </div>
